...
export default function Home() {
  ...
  const phrases = ["Mokhles Tarmiz", "Full stack Js Developer", "UI/UX Artist"];
  ...
  return (
    <div className="bg-black text-white overflow-hidden w-screen">
      ...
      <div className="relative h-screen w-full flex flex-col items-center justify-center text-white">
        ...
        >
          <motion.h1 className="relative xl:text-8xl text-4xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-600">
            {typedText}
      ...
      <div
        className="relative min-h-screen flex flex-col items-center justify-center bg-black/50"
        ref={terminalRef}
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full max-w-7xl mx-auto p-8 relative z-30">
          ...
          >
            <h2 className="text-4xl font-bold">
              <MorphingText
                originalText="Sneak peek at the"
                speed={80}
                glitchIntensity={0.5}
              />
              <span className="text-blue-400"> latest projects </span>
            </h2>
            <MorphingParagraph
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 w-full max-w-7xl mx-auto relative z-20">
            ...
            >
              ...
              <p className="text-lg text-gray-300">
                Dive into the source code of my journey. This terminal is a peek
                under the hood of a passionate full stack developer—where
                curiosity compiles into projects, and creativity is pushed to
                production.
              </p>
              ...
              <div className="py-4">
                ...
                <ul className="space-y-2">
                  {[
                    "Scalable app architecture & responsive design",
                    "End-to-end JavaScript stack mastery",
                    "RESTful APIs & real-time systems",
                    "Pixel-perfect UI/UX implementation",
                    "Agile teamwork & rapid prototyping",
                  ].map((feature, i) => (
                    <motion.li
                      key={i}
                      className="flex items-center space-x-2"
              ...
              {[
                {
                  ...
                  description:
                    "Mastery in creating responsive, modern interfaces with React, Three.js and advanced CSS animations.",
                  icon: "🎨",
                },
                {
                  title: "Mobile Development",
                  description:
                    "Building cross-platform mobile applications with React Native and Expo that deliver native-like performance.",
                  icon: "📱",
                },
                {
                  title: "Back-End Solutions",
                  description:
                    "Creating robust APIs and server architectures using Node.js, Express, and various database technologies.",
                  icon: "⚙️",
                },
              ].map((feature, i) => (
                <motion.div
      ...
      {isScrolled && (
        <div className="relative min-h-screen  flex flex-col justify-center items-center px-4 py-20">
          <div className="absolute inset-0 bg-grid-pattern opacity-20 z-0"></div>

          {/* Center Content */}
          <div className="relative z-10 max-w-4xl mx-auto text-center flex flex-col justify-center flex-grow">
            <motion.h2
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative z-10 mt-auto pt-20"
          >
