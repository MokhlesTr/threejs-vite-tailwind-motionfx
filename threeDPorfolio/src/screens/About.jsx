...
export default function About() {
  ...
  return (
    <div className="relative w-full min-h-screen overflow-y-auto">
      ...
      <div className={`fixed inset-0 ${canvasError ? 'bg-indigo-900/20' : 'bg-black/40'} z-15`}></div>
      ...
      >
                      ...
                      {"MOKHLES TARMIZ".split("").map((letter, index) => (
                        <motion.span
                          ...
                          animate={{ 
                            opacity: 1, 
                            filter: "blur(0px)",
                            textShadow: "0 0 15px rgba(56, 189, 248, 0.8), 0 0 30px rgba(56, 189, 248, 0.4)"
                          }}
                          transition={{ 
                            duration: 0.15,
                            delay: index * 0.08,
          ...
          >
            <div className="bg-gradient-to-r from-blue-500 to-purple-500 p-1 rounded-full mb-6">
              <div className="bg-gray-900 p-1 rounded-full">
                <div className="text-gray-300 px-4 py-1 rounded-full text-sm md:text-base">
                  <span className="text-blue-400 font-semibold">Etherial</span> • Ecole Polytechnique de Sousse
                </div>
              </div>
            </div>
            ...
            <div className="text-gray-300 max-w-2xl text-lg md:text-xl relative overflow-hidden">
              ...
              >
                ...
                >Software Engineering student</motion.span> at Polytechnique Sousse and a <motion.span 
                  ...
                  animate={{ 
                    backgroundColor: ["rgba(74, 222, 128, 0.2)", "rgba(74, 222, 128, 0)"],
                  }}
                  transition={{ duration: 1.5, repeat: Infinity, repeatType: "reverse", delay: 0.5 }}
                >Full Stack Js Developer</motion.span> with professional experience in building scalable web and mobile applications, passionate about learning new technologies, collaborating with cross-functional teams and driving projects from concept to completion.
              </motion.p>
            </div>
            ...
            <div className="text-gray-300 max-w-2xl mt-4 text-lg md:text-xl">
              ...
              >
                Currently, I work as a <motion.span
                  className="relative inline-block"
                >
                  <motion.span 
                    className="relative z-10 font-semibold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-indigo-500"
                  >
                  ...
                  />
                </motion.span>, specializing in <motion.span
                ...
                >React Native, Expo and Express.js</motion.span> to deliver high-quality solutions that meet business needs.
              </motion.p>
            </div>
            
            <div className="flex items-center mt-6 space-x-2">
              <div className="w-2 h-2 bg-green-400 rounded-full"></div>
              <p className="text-gray-300 text-sm">Gouvernorat Sousse, Tunisie</p>
            </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
            ...
            >
              ...
              <div className="p-5">
                <h3 className="text-xl font-bold text-white mb-2">Mobile E-Commerce App</h3>
                <p className="text-gray-300 mb-4">A React Native app with Expo and Express.js backend for seamless shopping experiences.</p>
                <div className="flex flex-wrap gap-2">
                  <span className="px-2 py-1 bg-blue-500/20 rounded-md text-blue-400 text-xs font-medium">React Native</span>
                  <span className="px-2 py-1 bg-purple-500/20 rounded-md text-purple-400 text-xs font-medium">Expo</span>
                  <span className="px-2 py-1 bg-green-500/20 rounded-md text-green-400 text-xs font-medium">Node.js</span>
                </div>
              </div>
              {flippedIndex === 0 && (
                <motion.div
                ...
                >
                  ...
                  <p className="text-gray-300 text-center mb-4">
                    Built a complete e-commerce solution with user authentication, product catalog, cart functionality, and payment integration.
                  </p>
                  <div className="flex space-x-3 mt-2">
                    <a href="#" className="px-4 py-2 bg-blue-600 rounded-md text-white text-sm font-medium hover:bg-blue-700 transition">View Demo</a>
                    <a href="#" className="px-4 py-2 bg-gray-700 rounded-md text-white text-sm font-medium hover:bg-gray-800 transition">GitHub</a>
                  </div>
                </motion.div>
              )}
            </motion.div>
            ...
            >
              ...
              <div className="p-5">
                <h3 className="text-xl font-bold text-white mb-2">AI Task Management</h3>
                <p className="text-gray-300 mb-4">A smart task management system with AI prioritization and scheduling.</p>
                <div className="flex flex-wrap gap-2">
                  <span className="px-2 py-1 bg-blue-500/20 rounded-md text-blue-400 text-xs font-medium">React</span>
                  <span className="px-2 py-1 bg-yellow-500/20 rounded-md text-yellow-400 text-xs font-medium">Express</span>
                  <span className="px-2 py-1 bg-purple-500/20 rounded-md text-purple-400 text-xs font-medium">MongoDB</span>
                </div>
              </div>
              {flippedIndex === 1 && (
                <motion.div
                ...
                >
                  <h3 className="text-xl font-bold mb-2">Project Details</h3>
                  <p className="text-gray-300 text-center mb-4">
                    Developed an intelligent task manager that uses machine learning to prioritize tasks and suggest optimal schedules based on user patterns.
                  </p>
                  <div className="flex space-x-3 mt-2">
                    <a href="#" className="px-4 py-2 bg-blue-600 rounded-md text-white text-sm font-medium hover:bg-blue-700 transition">View Demo</a>
                    <a href="#" className="px-4 py-2 bg-gray-700 rounded-md text-white text-sm font-medium hover:bg-gray-800 transition">GitHub</a>
            ...
            >
              ...
              <div className="p-5">
                <h3 className="text-xl font-bold text-white mb-2">3D Portfolio</h3>
                <p className="text-gray-300 mb-4">An interactive 3D portfolio website with Three.js animations and effects.</p>
                <div className="flex flex-wrap gap-2">
                  <span className="px-2 py-1 bg-blue-500/20 rounded-md text-blue-400 text-xs font-medium">React</span>
                  <span className="px-2 py-1 bg-gray-500/20 rounded-md text-gray-400 text-xs font-medium">Three.js</span>
                  <span className="px-2 py-1 bg-indigo-500/20 rounded-md text-indigo-400 text-xs font-medium">Tailwind</span>
                </div>
              </div>
              {flippedIndex === 2 && (
                <motion.div
                ...
                >
                  <h3 className="text-xl font-bold mb-2">Project Details</h3>
                  <p className="text-gray-300 text-center mb-4">
                    Created an immersive portfolio experience with 3D elements, interactive animations, and a responsive design that showcases projects in a unique way.
                  </p>
                  <div className="flex space-x-3 mt-2">
                    <a href="#" className="px-4 py-2 bg-blue-600 rounded-md text-white text-sm font-medium hover:bg-blue-700 transition">View Demo</a>
                    <a href="#" className="px-4 py-2 bg-gray-700 rounded-md text-white text-sm font-medium hover:bg-gray-800 transition">GitHub</a>
        ...
        >
          <h2 className="text-3xl font-bold text-white mb-12 text-center">My Resume</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            >
              ...
              <p className="text-gray-300 mb-8">
                Get a comprehensive overview of my skills, experience and educational background in my professionally crafted resume.
              </p>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="w-full bg-gray-700 rounded-full h-2">
                    <div className="bg-gradient-to-r from-blue-400 to-purple-500 h-2 rounded-full" style={{ width: '95%' }}></div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="w-full bg-gray-700 rounded-full h-2">
                    <div className="bg-gradient-to-r from-blue-400 to-purple-500 h-2 rounded-full" style={{ width: '90%' }}></div>
                  </div>
                </div>
